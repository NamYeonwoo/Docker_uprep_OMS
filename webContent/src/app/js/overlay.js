(function(window, $) {
    ...
    control.createOverlayListDataTable = function(data, typeFlag, callback){
        ...
        for(var index = 0; index < control.overlayData.length; index++){
            ...
            trTag +=    "<button type='button' class='btn-danger m-r-3' value='"+ overlay_network_id +"'>Delete</button>";
    ...
    control.bindingDataTableSelectEvent = function(){
        ...
        control.getOverlayListGrid().delegate("td","click",function(){
            ...
            if(col != null) {
                ...
                if(row != null) {
                    var rowData = $.grep(control.overlayData,function(e){return e.OVERLAY_NETWORK_ID == row.cells["OVERLAY_NETWORK_ID"].textContent});
                    var data = null;
